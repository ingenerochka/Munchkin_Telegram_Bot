...
# TODO: СДЕЛАНО сделать механизм получения очков за победу над монстром - прибавлять к текущим очкам пользователя
# TODO: СДЕЛАНО сделать механизм проверки уровня после прибавления очков и уведомлять пользователя, если уровень повышен
# TODO: СДЕЛАНО создать бд сокровищ с 5 вариантами
...
# TODO: СДЕЛАНО сделать блок смывки, также кидать кубик, если выпало больше 5 - герой смылся и не получает эскалацию